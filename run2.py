...
CONFIG_PATH = MODEL_PATH+'/ssd_mobnet_ckp_alphabet/pipeline.config'
CHECKPOINT_PATH = MODEL_PATH+'/ssd_mobnet_ckp_alphabet/'
CUSTOM_MODEL_NAME = 'ssd_mobnet_ckp_alphabet'
CONFIG_PATH = MODEL_PATH+'/'+CUSTOM_MODEL_NAME+'/pipeline.config'
category_index = label_map_util.create_category_index_from_labelmap(ANNOTATION_PATH+'/label_map2.pbtxt')
